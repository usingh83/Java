...
public class InnerClassPowerOf2 {
	...
	public static void main(String[] args) throws Exception {
		...
		try{
			...
			Object o;// Must be used to hold the reference of the instance of the class InnerClassPowerOf2.Inner.Private
			InnerClassPowerOf2.Inner a=new InnerClassPowerOf2.Inner();
			Inner.Private c=a.new Private();
			String res=c.powerof2(num);
